...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('AppBundle\\Form\\Type\\DocumentSearchType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\Type\DocumentSearchType']) ? $this->services['AppBundle\Form\Type\DocumentSearchType'] : $this->services['AppBundle\Form\Type\DocumentSearchType'] = new \AppBundle\Form\Type\DocumentSearchType()) && false ?: '_'};
