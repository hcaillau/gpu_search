...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array(), $containerDir = __DIR__)
    {
        ...
        $this->normalizedIds = array(
            'appbundle\\controller\\autocompletecontroller' => 'AppBundle\\Controller\\AutocompleteController',
            ...
            'appbundle\\form\\type\\documentsearchtype' => 'AppBundle\\Form\\Type\\DocumentSearchType',
        ...
        $this->fileMap = array(
            'AppBundle\\Controller\\AutocompleteController' => 'getAutocompleteControllerService.php',
            ...
            'AppBundle\\Form\\Type\\DocumentSearchType' => 'getDocumentSearchTypeService.php',
            ...
            'app.extractor.document' => 'getApp_Extractor_DocumentService.php',
            'app.index.document' => 'getApp_Index_DocumentService.php',
            ...
            'console.command.appbundle_command_bulk_bulkdocumentcommand' => 'getConsole_Command_AppbundleCommandBulkBulkdocumentcommandService.php',
            'console.command.appbundle_command_extract_extractdocumentcommand' => 'getConsole_Command_AppbundleCommandExtractExtractdocumentcommandService.php',
        ...
        $this->privates = array(
            ...
            'AppBundle\\Form\\Type\\DocumentSearchType' => true,
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('EtdNODfeN3', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('mQjqAwGKiF', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('8Rchq7sl3V', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Q3kgxevNZc', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'es_url' => 'http://rks1409w113.ign.fr:9200',
            'gpu_url' => 'https://www.geoportail-urbanisme.gouv.fr',
            'locale' => 'en',
            ...
            'console.command.ids' => array(
                'console.command.appbundle_command_bulk_bulkdocumentcommand' => 'console.command.appbundle_command_bulk_bulkdocumentcommand',
                'console.command.appbundle_command_extract_extractdocumentcommand' => 'console.command.appbundle_command_extract_extractdocumentcommand',
